...
- **todo-service** — two instances on :8081 & :8082, shared MySQL DB
...
CLIENT-SERVICE (:8080)          ← registers with Eureka
    ...
    ▼
┌─────────────┐   ┌─────────────┐
│ todo-service│   │ todo-service│   ← both register with Eureka
│   :8081     │   │   :8082     │
└──────┬──────┘   └──────┬──────┘
       └────────┬─────────┘
                ▼
...
Both instances will appear in the Eureka dashboard under the name **TODO-SERVICE**.
